...
fun main(args: Array<String>) {
    ...
    mShoppingList.sort()
    println("mSoppingList sorted: $mShoppingList")
    mShoppingList.reverse()
    println("mShoppingList reversed: $mShoppingList")

    val mShoppingSet = mShoppingList.toMutableSet()
    println("mShoppingSet: mShoppingSet: $mShoppingSet")
    ...
    val mRecipeMap = mutableMapOf("Recipe" to r1, "Recipe2" to r2, "Recipe3" to r3)
